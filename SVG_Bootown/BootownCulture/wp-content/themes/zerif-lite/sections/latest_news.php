						...
						if ( $zerif_latest_loop->have_posts() ) :
							...
							while ( $zerif_latest_loop->have_posts() ) : $zerif_latest_loop->the_post();
								...
								if ( !wp_is_mobile() ){
										...
										echo '<div class="col-sm-12 latestnews-box">';

											echo '<div class="latestnews-img col-sm-3">';
											...
											echo '<div class="latesnews-content col-sm-9">';
									...
									echo '<div class="item '.$active.'">';
										echo '<div class="col-md-12 latestnews-box">';
